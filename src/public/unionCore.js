...
var controler = function (can2) {
	...
	can2.setup = function () {
		...
		setCarVol.position(10, 220).style('font-family', 'sans-serif');
		...
		setCarFreq = can2.createSlider(0, 1000, 0, 1); // from, to, init, step
		setCarFreq.size(x - 120);
		setCarFreq.position(10, 270).style('font-family', 'sans-serif');
		...
		setModVol.position(10, 320).style('font-family', 'sans-serif');
		...
		setModFreq.position(10, 370).style('font-family', 'sans-serif');
		...
		setModRand.position(10, 420).style('font-family', 'sans-serif');
		...
		setCarRand.position(10, 470).style('font-family', 'sans-serif');
	...
	can2.draw = function () {
		...
		can2.text('Amp:Car', x - 100, 160);
		can2.text('Freq:Car', x - 100, 210);
		can2.text('Amp:Mod', x - 100, 260);
		can2.text('Freq:Mod', x - 100, 310);
		can2.text('Feedback', x - 100, 360);
		can2.text('Delay', x - 100, 410);
	};
};
